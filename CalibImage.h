...
class CalibImage {
   public:
    ...
    struct ErrorAndJacobians {
        ...
        cv::Matx<double, 2, NUMTRACKERCAMPARAMETERS>
            m2NCameraJac;  // 2 x NUMTRACKERCAMPARAMETERS !

        // EAJ definitely needs a constructor now...
        ErrorAndJacobians()
            : m26PoseJac(cv::Matx<double, 2, 6>()),
              m2NCameraJac(cv::Matx<double, 2, NUMTRACKERCAMPARAMETERS>()) {}
    };
