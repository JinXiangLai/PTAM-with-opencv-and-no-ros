...
// [R' | -R'*b]
template <typename P>
bool extractSE3FromEssentialMatrix(
    cv::Matx<P, 3, 3>& m3E,   // The (pure) essential matrix
    ...
    cv::Matx<P, 3, 3> C;
    C(0, 0) = e22 * e33 - e32 * e23;
    C(0, 1) = -(e21 * e33 - e31 * e23);
    C(0, 2) = e21 * e32 - e31 * e22;
    C(1, 0) = -(e12 * e33 - e32 * e13);
    C(1, 1) = e11 * e33 - e31 * e13;
    C(1, 2) = -(e11 * e32 - e31 * e12);
    C(2, 0) = e12 * e23 - e22 * e13;
    C(2, 1) = -(e11 * e23 - e21 * e13);
    C(2, 2) = e11 * e22 - e21 * e12;
    ...
    P bx = sqrt(fabs(1 - ee1)), by = sqrt(fabs(1 - ee2)),
      bz = sqrt(fabs(1 - ee3));
...
inline double recontructDepth2Views(P1 x1, P1 y1, P2 x2, P2 y2,
    ...
    C[0] = (m3R(0, 0) - m3R(0, 2) * x2) * (m3R(0, 0) - m3R(0, 2) * x2) +
           (m3R(0, 1) - m3R(0, 2) * y2) * (m3R(0, 1) - m3R(0, 2) * y2);

    C[1] = (m3R(0, 0) - m3R(0, 2) * x2) * (m3R(1, 0) - m3R(1, 2) * x2) +
           (m3R(0, 1) - m3R(0, 2) * y2) * (m3R(1, 1) - m3R(1, 2) * y2);

    C[2] = (m3R(0, 0) - m3R(0, 2) * x2) * (m3R(2, 0) - m3R(2, 2) * x2) +
           (m3R(0, 1) - m3R(0, 2) * y2) * (m3R(2, 1) - m3R(2, 2) * y2);

    C[3] = (m3R(1, 0) - m3R(1, 2) * x2) * (m3R(1, 0) - m3R(1, 2) * x2) +
           (m3R(1, 1) - m3R(1, 2) * y2) * (m3R(1, 1) - m3R(1, 2) * y2);

    C[4] = (m3R(1, 0) - m3R(1, 2) * x2) * (m3R(2, 0) - m3R(2, 2) * x2) +
           (m3R(1, 1) - m3R(1, 2) * y2) * (m3R(2, 1) - m3R(2, 2) * y2);

    C[5] = (m3R(2, 0) - m3R(2, 2) * x2) * (m3R(2, 0) - m3R(2, 2) * x2) +
           (m3R(2, 1) - m3R(2, 2) * y2) * (m3R(2, 1) - m3R(2, 2) * y2);

    // now obtain the numerator and denominator that yield the depth fraction
    double denominator = x1 * (x1 * C[0] + y1 * C[1] + C[2]) +
                         y1 * (x1 * C[1] + y1 * C[3] + C[4]) + x1 * C[2] +
                         y1 * C[4] + C[5];
