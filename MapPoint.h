...
struct MapPoint {
   public:
    ...
    std::shared_ptr<KeyFrame>
        pPatchSourceKF;  // The KeyFrame the point was originally made in
    ...
    cv::Vec3f
        v3Center_NEC;  // Unit vector in Source-KF coords pointing at the patch center
    cv::Vec3f
        v3OneDownFromCenter_NEC;  // Unit vector in Source-KF coords pointing towards one pixel down of the patch center
    cv::Vec3f
        v3OneRightFromCenter_NEC;  // Unit vector in Source-KF coords pointing towards one pixel right of the patch center
    cv::Vec3f
        v3Normal_NEC;  // Unit vector in Source-KF coords indicating patch normal

    cv::Vec3f
        v3PixelGoDown_W;  // 3-Vector in World coords corresponding to a one-pixel move down the source image
    cv::Vec3f
        v3PixelGoRight_W;  // 3-Vector in World coords corresponding to a one-pixel move right the source image
